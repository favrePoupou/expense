...
export class UserApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation userRole.
   *
   ...
   * </em>
   */
  public getUserRole(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Fetches belongsTo relation userOrganisation.
   *
   * @param {any} id user id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getUserOrganisation(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userOrganisation";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for expenses
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdExpenses(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/expenses/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   */
  public destroyByIdExpenses(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateByIdExpenses(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Fetches hasOne relation userSettings.
   *
   * @param {any} id user id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getUserSettings(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Creates a new instance in userSettings of this model.
   *
   * @param {any} id user id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createUserSettings(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Update userSettings of this model.
   *
   * @param {any} id user id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public updateUserSettings(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userSettings";
    let _routeParams: any = {
  ...
  /**
   * Deletes userSettings of this model.
   *
   * @param {any} id user id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public destroyUserSettings(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userSettings";
    let _routeParams: any = {
  ...
  /**
   * Find a related item by id for userClients.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for userClients
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdUserClients(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for userClients.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for userClients
   ...
   * This method returns no data.
   */
  public destroyByIdUserClients(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for userClients.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for userClients
   ...
   * </em>
   */
  public updateByIdUserClients(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getExpenses(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/expenses";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createExpenses(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/expenses";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteExpenses(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/expenses";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countExpenses(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/expenses/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getUserClients(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in userClients of this model.
   *
   * @param {any} id user id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createUserClients(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients";
    let _routeParams: any = {
  ...
  /**
   * Deletes all userClients of this model.
   *
   * @param {any} id user id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteUserClients(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countUserClients(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyUserSettings(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userSettings";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyExpenses(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/expenses";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyUserClients(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/userClients";
    let _routeParams: any = {
