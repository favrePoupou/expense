...
/**
 * Api services for the `UserOrganisation` model.
 */
@Injectable()
export class UserOrganisationApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id UserOrganisation id
   *
   ...
   * This usually means the response is a `UserOrganisation` object.)
   * </em>
   */
  public findByIdUsers(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userOrganisations/:id/users/:fk";
  ...
  /**
   * Queries users of UserOrganisation.
   *
   * @param {any} id UserOrganisation id
   *
   * @param {object} filter 
  ...
  /**
   * Counts users of UserOrganisation.
   *
   * @param {any} id UserOrganisation id
   *
  ...
  public countUsers(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userOrganisations/:id/users/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
